...
const NOTE_BY_REGION = {
  ...
  triad: (n) => `The team runs up I-85 toward the Triad regularly. ${n} dates work best booked a few weeks out so travel and prep line up.`,
  ...
  extended: (n) => `${n} is extended-travel territory. It is absolutely doable — it just works best for larger events booked well ahead so the drive makes sense for everyone.`,
};
...
export const SERVICES = [
  {
    ...
    note: 'The truck is based in Charlotte and serves all of North Carolina. Metro dates are easiest; longer runs work best for bigger events booked ahead.',
    faq: [
  ...
  },
  {
    ...
    note: 'Trays are the most flexible way to book — they scale from a family dinner to a few hundred plates and travel anywhere in North Carolina.',
    faq: [
