...
export const REGIONS = [
  { key: 'metro', label: 'Verified Charlotte-area markets', badge: 'Based in Charlotte' },
];
...
export const CITIES = [
  ...
  C('Concord', 'concord', 'metro',
    ...
    ['charlotte', 'huntersville', 'gastonia']),
...
export const SERVICES = [
  {
    ...
    note: 'The truck is based in Charlotte. Confirmed website service areas are Charlotte, Concord, Gastonia, and Huntersville; every event is reviewed for date, travel, and site fit.',
    faq: [
      ...
      ['What if my event is outside the listed service area?', 'Send the date, address, and guest count. The team will confirm honestly whether travel fits before quoting.'],
    ],
  },
  {
  ...
  },
  {
    ...
    note: 'Trays are the most flexible way to book. Confirmed service areas are Charlotte, Concord, Gastonia, and Huntersville; other addresses require direct confirmation.',
    faq: [
